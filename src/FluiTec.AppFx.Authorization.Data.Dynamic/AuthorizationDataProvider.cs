using System;
using FluiTec.AppFx.Authorization.Data.Dapper.Mssql;
using FluiTec.AppFx.Authorization.Data.Dapper.Mysql;
using FluiTec.AppFx.Authorization.Data.Dapper.Pgsql;
using FluiTec.AppFx.Authorization.Data.Dynamic.Configuration;
using FluiTec.AppFx.Authorization.Data.LiteDb;
...
namespace FluiTec.AppFx.Authorization.Data.Dynamic
{
    /// <summary>   An authorization data provider. </summary>
    public class AuthorizationDataProvider
    {
        /// <summary>	Options for controlling the operation. </summary>
        private readonly AuthorizationDataOptions _options;

        /// <summary>	Constructor. </summary>
        /// <param name="options">	Options for controlling the operation. </param>
        public AuthorizationDataProvider(AuthorizationDataOptions options)
        {
