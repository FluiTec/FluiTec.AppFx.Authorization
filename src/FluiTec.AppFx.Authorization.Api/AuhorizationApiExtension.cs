...
namespace FluiTec.AppFx.Authorization.Api
{
    ...
    public static class AuhorizationApiExtension
    {
        ...
        public static IServiceCollection ConfigureAuthorizationApi(this IServiceCollection services, IConfigurationRoot configuration, string configurationName = "AuthorizationServiceOptions")
        {
            ...
            services.AddAuthorization(aOptions =>
            {
                ...
                {
                    aOptions.AddPolicy(o, builder => { builder.Requirements.Add(new AuhtorizedForActionRequirement(o)); });
                }
            });
            return services;
        }
        ...
        public static void SynchronizeAuthorizationActivities(AuthorizationService service, AuthorizationServiceOptions options)
        {
