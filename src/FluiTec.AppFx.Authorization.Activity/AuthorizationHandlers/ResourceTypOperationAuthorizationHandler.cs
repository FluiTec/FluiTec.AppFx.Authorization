...
namespace FluiTec.AppFx.Authorization.Activity.AuthorizationHandlers
{
    ...
    public class ResourceTypOperationAuthorizationHandler : AuthorizationHandler<ResourceTypeOperationRequirement>
    {
        ...
        private readonly ConcurrentDictionary<ClaimsPrincipal, IEnumerable<ActivityRoleEntity>> _activities =
            new ConcurrentDictionary<ClaimsPrincipal, IEnumerable<ActivityRoleEntity>>();
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context,
            ResourceTypeOperationRequirement requirement)
        {
